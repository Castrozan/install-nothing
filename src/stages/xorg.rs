...
impl InstallationStage for XorgStage {
    ...
    fn run(&self, exit_check: &dyn Fn() -> bool) -> io::Result<()> {
        ...
        println!(
            ...
            "Installing X.Org Server...".bright_white()
        );
        ...
        println!(
            "{} {}",
            LogGenerator::timestamp().dimmed(),
            "Probing graphics hardware...".dimmed()
        );
        ...
        println!(
            "{} {}",
            LogGenerator::timestamp().dimmed(),
            format!("  Detected: {} Graphics", gpu).bright_green()
        );
        ...
        println!(
            "{} {}",
            LogGenerator::timestamp().dimmed(),
            "  Resolution: 1920x1080@60Hz".dimmed()
        );
        println!(
            "{} {}",
            LogGenerator::timestamp().dimmed(),
            "  Color depth: 24-bit".dimmed()
        );
